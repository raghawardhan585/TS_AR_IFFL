...
dict_training_params = {'step_size_val': 0.3, 'train_error_threshold': float(1e-10),'valid_error_threshold': float(1e-6), 'max_epochs': 5000, 'batch_size': batch_size}
ls_dict_training_params.append(dict_training_params)
...
ls_dict_training_params.append(dict_training_params)
# dict_training_params = {'step_size_val': 0.08, 'train_error_threshold': float(1e-8), 'valid_error_threshold': float(1e-8), 'max_epochs': 5000, 'batch_size': batch_size}
# ls_dict_training_params.append(dict_training_params)
